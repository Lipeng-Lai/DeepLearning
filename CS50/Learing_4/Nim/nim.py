...
class Nim():
    ...
    def __init__(self, initial=[1, 3, 5, 7]): # 初始化石头堆
        """
    ...
    @classmethod
    def other_player(cls, player): # 轮到对手出手
        """
    ...
    def switch_player(self): # 将当前玩家切换到其他玩家
        """
    ...
    def move(self, action):
        ...
        采取的行动必须是 上面的枚举出的action中的一种
        """
        pile, count = action # 元组的形式:map <first, second> : 其中first为石堆的编号, second为该编号石堆的石头个数
